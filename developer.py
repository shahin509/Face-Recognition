...
# This part is image labels setting start 
        # first header image  
        img=Image.open(r"images\t_bg1.jpg")
        ...
        bg1=bg1.resize((1430,500),Image.ANTIALIAS)
        self.photobg1=ImageTk.PhotoImage(bg1)

        # set image as lable
        bg_img = Label(self.root,image=self.photobg1)
        bg_img.place(x=30,y=200,width=1430,height=500)


        #title section
        title_lb1 = Label(bg_img,text="Developer Pannel",font=("verdana",30,"bold"),fg="navyblue",bg="white")
        title_lb1.place(x=0,y=0,width=1530,height=45)

        # Create buttons below the section 
        # ------------------------------------------------------------------------------------------------------------------- 
        # student button 1
        std_img_btn=Image.open(r"images\m.jpg")
        ...
        det_img_btn=Image.open(r"images\f.jpg")
        ...
        att_img_btn=Image.open(r"images\w.jpg")
        ...
        hlp_img_btn=Image.open(r"images\m1.png")
