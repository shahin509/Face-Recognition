...
mydata=[]                        #Global variable for importCsv Function 
...
class Attendance:
    ...
    def __init__(self,root):
        ...
        # second image 
        img1=Image.open(r"images\banner1.jpg")
        ...
        #title section
        title_lb1 = Label(bg_img,text="Welcome to Attendance Pannel",font=("times new roman",35,"bold"),bg="#1b1717",fg="#989898")
        ...
        # img_left=Image.open(r"images\42.jpg")
        ...
        self.attendanceReport.heading("Department",text="Dep")
