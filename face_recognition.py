...
class Face_Recognition:
    ...
    def __init__(self,root):
        ...
        title_lbl=Label(self.root,text="FACE RECOGNITION",font=("times new roman",35,"bold"),bg="#1b1717",fg="#989898")
        title_lbl.place(x=0,y=0,width=1530,height=45)

        ####   img_top  
        img_top=Image.open(r"images\42.jpg")
        ...
        ##########    img_bottom 
        img_bottom=Image.open(r"images\27.jpg")
        ...
        ### button
        b1_1=Button(f_lbl,text="Face Recognition",command=self.face_recog,cursor="hand2",font=("times new roman",18,"bold"),bg="#1b1717",fg="#989898")
    ...
    def mark_attendance(self,i,r,n,d):
        with open("attendance_report/attendance.csv","r+",newline="\n") as f:
            ...
            if((i not in name_list) and (r not in name_list) and (n not in name_list) and (d not in name_list)):
                ...
                f.writelines(f"\n{i}, {r}, {n}, {d}, {attendance_time}, {date}, Present")
    ...
    def face_recog(self):
        ...
        def draw_boundary(img,classifier,scaleFactor,minNeighbors,color,text,clf):
            ...
            for (x,y,w,h) in features:
                ...
                if confidence>77:
                    ...
                    cv2.putText(img,"Unknown Face",(x,y-5),cv2.FONT_HERSHEY_COMPLEX,0.8,(64,15,223),1)
        ...
        while True:
            ...
            cv2.putText(img, f'FPS: {int(fps)}', (20, 70), cv2.FONT_HERSHEY_PLAIN,
                        3, (0, 0, 0), 2)
            cv2.rectangle(img, (17, 23), (210, 80), (255, 255, 0), 2)            
